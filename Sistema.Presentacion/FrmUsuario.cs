...
namespace Sistema.Presentacion
{
    public partial class FrmUsuario : Form
    {
        ...
        private void Formato()
        {
            ...
            DgvListado.Columns[6].Width = 140;
        ...
        private void BtnInsertar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (CboRol.Text == string.Empty || TxtNombre.Text == string.Empty || TxtEmail.Text == string.Empty || TxtClave.Text == string.Empty)
                {
                    ...
                    ErroIcono.SetError(TxtClave, "Ingrese una Clave de acceso.");
        ...
        private void DgvListado_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                TxtNumDocumento.Text = Convert.ToString(DgvListado.CurrentRow.Cells["Numero_Documento"].Value);

...
namespace Sistema.Presentacion
{
    public partial class FrmIngreso : Form
    {
        ...
        private void CrearTabla()
        {
            ...
            DgvDetalle.Columns[1].Width = 130;
            DgvDetalle.Columns[2].HeaderText = "Articulo";
            DgvDetalle.Columns[2].Width = 430;
        ...
        private void FormatoArticulos()
        {
            ...
            DgvArticulos.Columns[1].Width = 10;
        ...
        private void TxtCodigo_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
                if (e.KeyCode == Keys.Enter)
                {
                    ...
                    {
                        this.MensajeError("No existe artículos con ese código de barras.");
                    }
                    else
                    {
                        this.AgregarDetalle(
        ...
        private void BtnInsertar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (TxtIdProveedor.Text == string.Empty || TxtImpuesto.Text == string.Empty || txtNumComprobante.Text == string.Empty || DtDetalle.Rows.Count==0)
                {
                    ...
                    ErroIcono.SetError(TxtIdProveedor, "Seleccione un proveedor.");
        ...
        private void BtnCloseDetalle_Click(object sender, EventArgs e)
        {
